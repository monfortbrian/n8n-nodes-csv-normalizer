...
function normalizeCsvData(inputData, options) {
    return new Promise((resolve, reject) => {
        try {
            ...
            const parsed = Papa.parse(csvData, {
                ...
                transformHeader: options.normalizeHeaders !== false
...
function normalizeExcelData(buffer, options) {
    return new Promise((resolve, reject) => {
        try {
...
function applyTransformations(data, options) {
    ...
    if (((_b = (_a = options.columnMappings) === null || _a === void 0 ? void 0 : _a.mapping) === null || _b === void 0 ? void 0 : _b.length) > 0) {
        const mappings = {};
